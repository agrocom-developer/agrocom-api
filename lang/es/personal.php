...
return [
    ...
    'personas' => [
        ...
        'campo_nombre' => 'Nombre',
        'campo_rol' => 'Rol',
        'campo_rol_placeholder' => 'Selecciona un rol',
        'campo_base' => 'Base',
    ...
    'equipos_trabajo' => [
        ...
        'vacio_titulo' => 'Todavía no hay equipos de trabajo',
        'vacio_detalle' => 'Los equipos de trabajo se conforman con sus integrantes (piloto, auxiliar) y equipamiento (drones, vehículos). Se registra uno nuevo desde el formulario de alta arriba.',
        'col_codigo' => 'Código',
        'col_nombre' => 'Nombre',
        'col_base' => 'Base',
        ...
        'editar' => 'Editar',
        'eliminar_accion' => 'Eliminar',
        'confirmar_baja' => '¿Confirmas la baja de este equipo de trabajo?',
        ...
        'campo_hasta_ayuda' => 'Déjalo vacío si el equipo sigue vigente.',
        'estado_form' => 'Los cambios se guardan al confirmar.',
