...
return [
    ...
    'ordenes_trabajo' => [
        ...
        'campo_escuadra' => 'Escuadra',
        'campo_escuadra_placeholder' => 'Selecciona una escuadra…',
        'escuadra_crear' => 'Crear una escuadra nueva',
        'escuadra_crear_corto' => 'Crear escuadra',
        'equipo_sin_opciones' => 'No hay escuadras vigentes hoy.',
        'error_escuadra_requerida' => 'Elige la escuadra que cubre este equipo.',
        'error_escuadra_repetida' => 'Esa escuadra ya cubre otro equipo de esta tanda.',
    ...
    'ordenes' => [
        ...
        'estado_ayuda' => [
            'emitida' => 'La orden está emitida: ya quedó registrada, pero todavía no se puede ejecutar y aún puedes editar todos sus datos. Al activarla pasa a «:paso» y se puede repartir entre los equipos de trabajo. Si ya no la necesitas, elimínala desde el listado.',
            'vigente' => 'La orden está vigente: la aplicación está en ejecución y se reparte entre los equipos de trabajo. Si te equivocaste en un dato, puedes corregirlo indicando el motivo. Solo se puede cerrar cuando todas sus hectáreas están asignadas y los equipos terminaron sus trabajos; entonces pasa a «:paso» y el contrato queda libre para emitir la siguiente aplicación. Si el clima o la logística la detienen, pausa la orden; si no se va a realizar, cancélala e indica la causa y el motivo.',
