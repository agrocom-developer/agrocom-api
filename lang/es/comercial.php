...
return [
    ...
    'clientes' => [
        ...
        'filtro_tipo_persona' => 'Tipo de persona',
        'filtro_tipo_persona_placeholder' => 'Todos los tipos',
        'filtro_campania' => 'Campaña',
        'filtro_campania_placeholder' => 'Todas las campañas',
        'filtro_tipo_contacto' => 'Tipo de contacto',
        'filtro_tipo_contacto_placeholder' => 'Cualquier tipo',
        'filtrar' => 'Buscar',
    ...
    'propiedades' => [
        ...
        'filtro_municipio_placeholder' => 'Todos los municipios',
        ...
        'campo_municipio_placeholder' => 'Busca o elige un municipio',
        'campo_municipio_ayuda' => 'Escribe el nombre para buscarlo: al elegirlo se completan el departamento y la provincia.',
        ...
        'aside_lotes_editar_bloque' => 'Editar en bloque',
        ...
        'lotes_generar_subtitulo' => 'Genera varios lotes de una vez, con sus hectáreas y atributos de terreno; después entras a cada uno a renombrarlo y dibujar su polígono.',
        ...
        // Pantalla "Editar en bloque" (19/9/2026): mismo formulario que "Crear
        // lotes", para los lotes que la propiedad ya tiene.
        'lotes_bloque_titulo' => 'Editar lotes en bloque — :propiedad',
        'lotes_bloque_subtitulo' => 'Corrige de una vez las hectáreas y el terreno de todos los lotes de la propiedad, y suma o quita lotes cambiando la cantidad.',
        'lotes_bloque_error' => 'Revisa los datos marcados antes de guardar los cambios.',
        'lotes_bloque_seccion_destino' => 'Lotes que se editan',
        'lotes_bloque_prefijo_ayuda' => 'Solo se usa para los lotes nuevos: los que ya existen conservan su código.',
        'lotes_bloque_cantidad_ayuda' => 'Es el total de lotes que tendrá la propiedad. Si subes el número se crean los que faltan (hasta :maximo por vez); si lo bajas se dan de baja los últimos lotes creados.',
        'lotes_generar_cantidad_ayuda' => 'Hasta :maximo lotes por vez. Si necesitas más, crea otra tanda: el número del código sigue desde el último.',
        'lotes_bloque_hectareas' => 'Hectáreas por lote',
        'lotes_bloque_hectareas_varian' => 'Distintas en cada lote',
        // Ayuda de las hectáreas por lote: una guía, no una regla. La propiedad
        // no es toda lote (hacienda, agua, caminos) y un lote de otro tamaño no
        // impide crear los demás.
        'lotes_bloque_hectareas_ayuda' => 'Es solo una guía: puedes usar otras hectáreas y ajustar cada lote después desde su ficha.',
        'lotes_bloque_hectareas_sin_superficie' => 'Si cargas las hectáreas de la propiedad, aquí verás cuántas conviene darle a cada lote. No es obligatorio.',
        'lotes_bloque_hectareas_sugerido' => 'Sugerido: :sugerido ha por lote (:superficie ha de la propiedad ÷ :lotes lotes en total).',
        'lotes_bloque_hectareas_sugerido_uno' => 'Sugerido: :sugerido ha, la superficie completa de la propiedad, porque tendrá un solo lote.',
        'lotes_bloque_hectareas_sugerido_restante' => 'Sugerido: :sugerido ha por lote nuevo (las :restante ha de la propiedad que aún no están en lotes ÷ :lotes lotes nuevos).',
        'lotes_bloque_hectareas_sin_restante' => 'Los lotes que ya tiene suman :asignadas ha, que igualan o superan las :superficie ha declaradas de la propiedad.',
        'lotes_bloque_hectareas_suma' => 'Con :hectareas ha por lote, el total de los lotes queda en :total ha.',
        'lotes_bloque_hectareas_suma_con_existentes' => 'Con :hectareas ha por lote nuevo, el total queda en :total ha (:asignadas ha de los lotes que ya tiene y :nuevas ha de los nuevos).',
        'lotes_bloque_hectareas_suma_menos' => 'Son :diferencia ha menos que las :superficie ha de la propiedad: el resto puede ser hacienda, agua u otros usos.',
        'lotes_bloque_hectareas_suma_mas' => 'Son :diferencia ha más que las :superficie ha de la propiedad. Es solo una guía: puedes crear los lotes igual y ajustar después los que midan distinto.',
        'lotes_bloque_hectareas_suma_igual' => 'Coincide con las :superficie ha de la propiedad.',
        'lotes_bloque_aviso_hectareas' => 'Los lotes tienen hectáreas distintas entre sí. Déjalas vacías para conservar las de cada lote, o escribe un valor para igualarlas todas.',
        'lotes_bloque_aviso_terreno' => 'Estos atributos del terreno no son iguales en todos los lotes: :atributos. Lo que dejes en el formulario se aplicará a todos.',
        'lotes_bloque_atributo_desnivel' => 'desnivel',
        'lotes_bloque_atributo_limpieza' => 'limpieza',
        'lotes_bloque_atributo_restricciones' => 'restricciones',
        'lotes_bloque_terreno_ayuda' => 'Se aplican a todos los lotes de la propiedad, los actuales y los nuevos — si alguno necesita algo distinto, se ajusta después desde su propia ficha.',
        'lotes_bloque_estado_form' => 'Los cambios se aplican a todos los lotes al guardar.',
        'lotes_bloque_quitar_varios' => 'Se darán de baja los últimos :cantidad lotes creados: :codigos.',
        'lotes_bloque_quitar_uno' => 'Se dará de baja el último lote creado: :codigos.',
        'lotes_bloque_quitar_mas' => 'y :cantidad más',
        'lotes_bloque_confirmar_titulo' => '¿Dar de baja los lotes sobrantes?',
        'lotes_bloque_confirmar_mensaje' => 'Los lotes con órdenes o trabajos asociados no se pueden quitar: si alguno de estos los tiene, no se aplica ningún cambio.',
        'lotes_bloque_confirmar_accion' => 'Dar de baja y guardar',
        'lotes_bloque_sin_permiso_crear' => 'No tienes permiso para crear lotes, así que la cantidad no puede subir.',
        'lotes_bloque_sin_permiso_eliminar' => 'No tienes permiso para dar de baja lotes, así que la cantidad no puede bajar.',
        'lotes_bloque_sin_cambios' => 'Los lotes ya estaban así: no había nada que cambiar.',
        'lotes_bloque_actualizados' => '{1} Se actualizó 1 lote.|[2,*] Se actualizaron :cantidad lotes.',
        'lotes_bloque_creados' => '{1} Se creó 1 lote nuevo.|[2,*] Se crearon :cantidad lotes nuevos.',
        'lotes_bloque_quitados' => '{1} Se dio de baja 1 lote.|[2,*] Se dieron de baja :cantidad lotes.',
    ],
    ...
    'contratos' => [
        ...
        'campo_campania_ayuda' => 'Solo se listan las campañas abiertas.',
    ...
    'validacion' => [
        ...
        'lotes_generar_cantidad_maxima' => 'Puedes crear hasta :maximo lotes por vez. Si necesitas más, crea otra tanda: el número del código sigue desde el último.',
        'lotes_bloque_hectareas_requeridas' => 'Indica las hectáreas de cada lote.',
        'lotes_bloque_cantidad_requerida' => 'Indica cuántos lotes debe tener la propiedad.',
        'lotes_bloque_cantidad_minima' => 'La propiedad debe quedar con al menos un lote.',
