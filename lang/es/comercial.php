...
return [
    ...
    'propiedades' => [
        ...
        'campo_geometria' => 'Perímetro de la propiedad',
        'campo_geometria_ayuda' => 'Dibujá sobre el mapa satelital los terrenos de la propiedad (puede haber más de uno, ej. terrenos separados).',
        'mapa_barra_aria' => 'Herramientas del mapa',
        'mapa_dibujar' => 'Dibujar terreno',
        'mapa_deshacer' => 'Deshacer',
        'mapa_borrar_todo' => 'Borrar todos los terrenos',
        'mapa_centrar' => 'Centrar',
