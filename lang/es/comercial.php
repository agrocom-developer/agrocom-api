...
return [
    ...
    'propiedades' => [
        ...
        'lotes_bloque_cantidad_ayuda' => 'Es el total de lotes que tendrá la propiedad. Si subes el número se crean los que faltan; si lo bajas se dan de baja los últimos lotes creados.',
        'lotes_bloque_hectareas' => 'Hectáreas por lote',
        'lotes_bloque_hectareas_varian' => 'Distintas en cada lote',
        'lotes_bloque_hectareas_ayuda' => 'Se calcula con la superficie de la propiedad y la cantidad de lotes.',
        'lotes_bloque_hectareas_sin_superficie' => 'Carga las hectáreas de la propiedad para ver cuántas conviene darle a cada lote.',
        'lotes_bloque_hectareas_sugerido' => 'Sugerido: :hectareas ha por lote (:superficie ha de la propiedad ÷ :lotes lotes en total).',
        'lotes_bloque_hectareas_sugerido_uno' => 'Sugerido: :hectareas ha, la superficie completa de la propiedad, porque tendrá un solo lote.',
        'lotes_bloque_hectareas_exceso' => 'Con :hectareas ha por lote, :lotes lotes suman :total ha y superan las :superficie ha de la propiedad. Sugerido: :sugerido ha por lote.',
        'lotes_bloque_hectareas_exceso_uno' => 'Con :hectareas ha, el lote supera las :superficie ha de la propiedad.',
    ...
    'validacion' => [
        ...
        'lotes_bloque_cantidad_maxima' => 'Solo puedes sumar hasta 50 lotes a la vez.',
