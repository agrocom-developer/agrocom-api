...
return [
    ...
    'usuarios' => [
        ...
        'col_nombre_usuario' => 'Nombre y usuario',
        'col_tipo' => 'Tipo',
        'col_roles' => 'Roles',
        'col_persona' => 'Persona',
        'col_estado' => 'Estado',
        ...
        'confirmar_eliminar_titulo' => 'Dar de baja al usuario',
        'confirmar_bloquear_titulo' => 'Bloquear el acceso',
        'confirmar_bloquear' => '¿Confirmas bloquear a este usuario? No podrá iniciar sesión hasta que lo desbloquees.',
        'confirmar_desbloquear_titulo' => 'Desbloquear el acceso',
        'confirmar_desbloquear' => '¿Confirmas desbloquear a este usuario? Podrá volver a iniciar sesión.',
        'estado_cambio_de_a' => 'Cambio de estado de acceso: de :desde a :hacia',
        ...
        // Resumen relacionado de la ficha (solo en edición)
        'aside_roles_titulo' => 'Roles asignados',
        'aside_roles_total' => 'Total',
        'aside_roles_nombres' => 'Roles',
        'aside_roles_accion' => 'Ver roles',
        'aside_roles_vacio_titulo' => 'Sin roles asignados',
        'aside_roles_vacio_detalle' => 'Sin roles la cuenta no puede operar el panel. Asígnalos en «Persona y roles».',
        'aside_persona_titulo' => 'Persona vinculada',
        'aside_persona_nombre' => 'Nombre',
        'aside_persona_rol' => 'Puesto',
        'aside_persona_base' => 'Base',
        'aside_persona_sin_base' => 'Sin base',
        'aside_persona_accion' => 'Ver en Personas',
        'aside_persona_vacio_titulo' => 'Sin persona vinculada',
        'aside_persona_vacio_detalle' => 'Sin persona, la cuenta no puede hacer lo que exige una persona, como aprobar una rendición. Vincúlala en «Persona y roles».',
        'aside_persona_baja_titulo' => 'La persona ya no existe',
        'aside_persona_baja_detalle' => 'La persona vinculada fue dada de baja. Elige otra en «Persona y roles».',
        'aside_dispositivos_titulo' => 'Dispositivos',
        'aside_dispositivos_total' => 'Sesiones abiertas',
        'aside_dispositivos_ultimo_uso' => 'Último uso',
        'aside_dispositivos_accion' => 'Ver dispositivos',
        'aside_dispositivos_vacio_titulo' => 'Sin dispositivos con sesión',
        'aside_dispositivos_vacio_detalle' => 'Esta cuenta no tiene sesión abierta en la app de campo.',
        'aside_contrato_titulo' => 'Contrato del portal',
        'aside_contrato_cliente' => 'Cliente',
        'aside_contrato_campania' => 'Campaña',
        'aside_contrato_sin_campania' => 'Sin campaña',
        'aside_contrato_accion' => 'Ver contratos del cliente',
        'aside_contrato_vacio_titulo' => 'Sin contrato',
        'aside_contrato_vacio_detalle' => 'El contrato de esta cuenta ya no existe o no está disponible.',
        'aside_bitacora_titulo' => 'Últimos movimientos',
        'aside_bitacora_accion' => 'Ver en la bitácora',
        'aside_bitacora_vacio_titulo' => 'Sin movimientos',
        'aside_bitacora_vacio_detalle' => 'Todavía no hay movimientos registrados de esta cuenta.',
    ],
    ...
    'dispositivos' => [
        ...
        'confirmar_revocar_titulo' => 'Revocar el acceso',
        'confirmar_revocar' => '¿Confirmas revocar el acceso de :usuario desde «:dispositivo»? Quien lo use tendrá que volver a iniciar sesión.',
        'filtro_busqueda_placeholder' => 'Usuario o dispositivo…',
        'filtro_rol' => 'Rol',
        'filtro_rol_todos' => 'Todos',
        'filtro_vacio_titulo' => 'Sin resultados para este filtro',
        'filtro_vacio_detalle' => 'Ningún dispositivo coincide con la búsqueda o el filtro aplicado. Prueba con otro término o quita el filtro.',
        'paginacion_aria' => 'Paginación de dispositivos',
    ...
    'perfil' => [
        ...
        'subtitulo_panel' => 'Tus datos de acceso, tus datos personales y los accesos de tu rol.',
        ...
        'persona_titulo' => 'Tus datos personales',
        'persona_nombre' => 'Nombre',
        'persona_rol' => 'Cargo',
        'persona_base' => 'Base',
        'persona_ci' => 'Documento (CI)',
        'persona_celular' => 'Celular',
        'persona_correo' => 'Correo',
        'persona_direccion' => 'Dirección',
        'persona_sin_dato' => 'Sin registrar',
        'persona_sin_base' => 'Sin base asignada',
        'persona_nota' => 'Solo lectura. Si algo no está correcto, pídele a un administrador que lo corrija.',
        'persona_nota_editable' => 'Solo lectura en esta pantalla. Puedes corregirlos desde Personal.',
        'persona_editar' => 'Editar en Personal',
        'persona_vacio_titulo' => 'Tu cuenta no está vinculada a una persona',
        'persona_vacio_detalle' => 'Un administrador puede vincularla desde Seguridad › Usuarios.',
        'persona_baja_titulo' => 'La persona vinculada a tu cuenta ya no está activa',
        'persona_baja_detalle' => 'Avisa a un administrador para que revise el vínculo.',
    ],
