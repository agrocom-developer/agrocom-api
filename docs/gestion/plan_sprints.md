...
| HU-02 | Como **usuario del panel**, quiero iniciar sesión y ver el menú AdminLTE armado según mis permisos, con mi tema de color preferido | Menú renderizado desde `sec_menu`/`sec_permission`; unión de roles; botones ocultos sin permiso; preferencia de tema persistida por usuario, ningún color hardcodeado (ADR 0002) | 1,5 d |
