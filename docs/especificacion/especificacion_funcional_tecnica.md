...
- `propiedades` — id, cliente_id, nombre, ubicación. *Un cliente tiene varias propiedades — el nivel de negocio ("Gamelera"), no necesariamente un único predio físico delimitado.*
