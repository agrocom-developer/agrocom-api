...
| **Hacienda** | Sinónimo de negocio de **campo** (`com_campos`): el predio físico donde trabaja la cuadrilla y se registran las estadías. No confundir con **propiedad**, el nivel de arriba que puede agrupar más de un campo | especificación §4.1, §4.3; ADR 0018 |
...
| **Estadía** | Registro de entrada y salida de un equipo de trabajo en una hacienda; dice cuántos días efectivos estuvo cada cuadrilla en cada hacienda (campo) | especificación §4.3 |
