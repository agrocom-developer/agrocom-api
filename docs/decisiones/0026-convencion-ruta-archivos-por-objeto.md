...
**Estado:** Aceptada. **Actualizada el mismo día de creación (23/9/2026, pedido directo del dueño)** — ver "Actualización 23/9/2026" al final de "Decisión": cambia el orden de la ruta de "actividad primero" a "objeto primero", y extiende el alcance de "clientes" a "trabajos" (y dos raíces reservadas: `personal/`, `propiedades/`).
