...
/**
 * Baja lógica de un lote (tarea 77, HU-54, etapa 2). Soft delete, nunca
 * físico (ADR 0007).
 *
 * Un lote con órdenes de aplicación o trabajos ejecutados en `Operaciones` no
 * se puede dar de baja — vía {@see VerificadorHistorialLote}.
 *
 * `updated_by` se fija a mano ANTES del `delete()`: mismo criterio que
 * `EliminarPropiedad` — el soft delete de Eloquent hace un `UPDATE` por
 * query builder que no dispara el evento `updating`.
 */
