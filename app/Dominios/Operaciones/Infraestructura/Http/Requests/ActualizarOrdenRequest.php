...
/**
 * `PUT /panel/ordenes/{orden}` (HU-25, tarea 38). Mismas reglas que
 * `CrearOrdenRequest` — ver su docblock para el porqué de cada rango y de no
 * exigir contrato `vigente`. Que la orden siga siendo editable (solo
 * `emitida`) no se valida acá: es una regla de ESTADO, no de forma, y vive
 * en `Aplicacion/ActualizarOrden` (invariante 7) para que también la
 * respete un `PUT` directo.
 */
