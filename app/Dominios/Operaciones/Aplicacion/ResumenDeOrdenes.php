...
final class ResumenDeOrdenes
{
     ...
     * @return array<int, array{lotes: int, ordenes_trabajo: int, incidencias: int, pausas: int, minutos_pausa: int}>
     */
    public function ejecutar(array $ordenIds): array
    {
        ...
        foreach ($ordenIds as $id) {
            $resumen[$id] = ['lotes' => 0, 'ordenes_trabajo' => 0, 'incidencias' => 0, 'pausas' => 0, 'minutos_pausa' => 0];
        }
