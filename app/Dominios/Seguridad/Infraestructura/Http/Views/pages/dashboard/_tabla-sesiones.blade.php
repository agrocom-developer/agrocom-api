{{--
    Parcial: tabla de sesiones (quinta vuelta — maquetas 4a/5a). Dos
    representaciones del MISMO dato, conmutadas por breakpoint en
    pages/dashboard.css:
    ...
    Novena vuelta: se retiró la columna RC + drill-down (prop $conRc) — era
    contenido exclusivo del tab "Sesiones", eliminado al pivotar el
    dashboard a un panel visual/estadístico (ver dashboard.blade.php).
--}}
