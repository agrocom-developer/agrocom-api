...
{
    $cliente = Cliente::create(['razon_social' => 'Cliente pausas '.uniqid()]);
    $campo = Campo::create(['cliente_id' => $cliente->id, 'nombre' => 'Campo pausas']);
    $lote = Lote::create(['campo_id' => $campo->id, 'codigo' => 'L-PAU-'.uniqid(), 'hectareas' => '50.00']);
